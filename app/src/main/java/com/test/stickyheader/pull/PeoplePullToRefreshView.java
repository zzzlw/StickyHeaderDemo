...
public class PeoplePullToRefreshView extends ViewGroup {
    ...
    private int refreshImageDiameter;
    private boolean showRefreshAnimation = true;
    ...
    public PeoplePullToRefreshView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);

    }

    public PeoplePullToRefreshView(Context context, AttributeSet attrs, int defStyle) {
        ...
        refreshImageDiameter = (int) (40 * metrics.density);
        mRefreshView = new LottieAnimationView(context);
        mRefreshView.setAnimation("loading.json");
        mRefreshView.loop(true);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mRefreshView.measure(MeasureSpec.makeMeasureSpec(refreshImageDiameter, MeasureSpec.EXACTLY),
                MeasureSpec.makeMeasureSpec(refreshImageDiameter, MeasureSpec.EXACTLY));
     ...
     * 是否显示动画效果
     *
     * @param refreshAnimation
     */
    public void setRefreshingAnimation(boolean refreshAnimation) {
        showRefreshAnimation = refreshAnimation;
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        mRefreshView.layout((width / 2 - refreshImageDiameter / 2), mCurrentOffsetTop - mTotalDragDistance / 2 - refreshViewHeight / 2,
                (width / 2 + refreshViewWidth / 2), mCurrentOffsetTop - mTotalDragDistance / 2 + refreshViewHeight / 2);
    }
